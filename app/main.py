...
def build_resume_page(request: Request, db: Session = Depends(get_db)):
    return templates.TemplateResponse(request, name="builder.html", context={
...
def blog_page(request: Request):
    return templates.TemplateResponse(request, name="blog/index.html", context={
...
def blog_post_page(request: Request, slug: str, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse(request, name="blog/post.html", context={
...
def create_blog_page(request: Request, email: str = Depends(get_verified_email)):
    ...
    return templates.TemplateResponse(request, name="blog/create.html", context={
